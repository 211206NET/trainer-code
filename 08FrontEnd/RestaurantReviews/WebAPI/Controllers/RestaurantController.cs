    ...
    public class RestaurantController : ControllerBase
    {
        ...
        public async Task<List<Restaurant>> GetAsync()
        {
            ...
            if(!_memoryCache.TryGetValue("restaurant", out allResto))
            {
                ...
                _memoryCache.Set("restaurant", allResto, new TimeSpan(0, 0, 5));
            }
            return allResto;
        }
        ...
        [HttpPut("{id}")]
        public Restaurant Put(int id, [FromBody] Restaurant restoToUpdate)
        {
            return (Restaurant) _bl.Update(restoToUpdate);
        }
        ...
        {
            _bl.Delete(await _bl.GetRestaurantByIdAsync(id));
        }
    }
}
